...
Page({
  ...
  toendOfNavigation:function(){
    wx.navigateTo({
      url: '/pages/endOfNavigation/endOfNavigation',
    })
    //将起始地的信息设置为全局变量
    app.globalData.startLatitude=this.data.textData.latitude
    app.globalData.startLongitude=this.data.textData.longitude
  }
